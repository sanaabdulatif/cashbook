  ...
  if (success) {
    return (
      <div className="bg-gradient-to-br from-surface via-surface-container-low to-[#fbe8ec] min-h-screen flex items-center justify-center p-4">
        <main className="w-full max-w-md bg-surface-container-lowest rounded-xl border border-outline-variant shadow-ambient p-8 flex flex-col items-center text-center gap-6 animate-fadeIn">
          <div className="w-16 h-16 rounded-full bg-cashin-bg flex items-center justify-center text-cashin mb-2 shadow-ambient">
            <CheckCircle2 className="w-8 h-8" />
          </div>
          <h1 className="font-bold text-2xl text-on-surface">Confirm your email</h1>
          <p className="text-sm text-secondary">
            We sent a verification link to <span className="font-semibold text-primary">{getValues('email')}</span>. Please click the link to confirm your account and log in.
          </p>
          <Link
            to="/login"
            className="w-full bg-primary text-on-primary font-bold py-2.5 rounded-xl hover:bg-primary-dark transition-all text-sm shadow-sm flex items-center justify-center"
          >
            Go to Login
          </Link>
        </main>
      ...
      <main className="w-full max-w-md bg-surface-container-lowest rounded-xl border border-outline-variant shadow-ambient p-8 flex flex-col gap-6">
        ...
        <header className="flex flex-col items-center text-center gap-1.5">
          ...
          <p className="text-xs text-secondary">
            Start organizing your cash flow in seconds.
          </p>
        </header>
          ...
          <div className="flex flex-col gap-1 text-left">
            ...
            <input
              ...
              className={`w-full h-[44px] px-3.5 rounded-[12px] border ${
                errors.fullName ? 'border-cashout focus:border-cashout focus:ring-cashout/10' : 'border-outline-variant focus:border-primary focus:ring-primary/10'
          ...
          <div className="flex flex-col gap-1 text-left">
            <label className="flex items-start gap-2 cursor-pointer select-none text-xs">
              <input
                ...
                type="checkbox"
                {...register('agreeTerms')}
                className="w-4 h-4 mt-0.5 rounded text-primary border-outline-variant focus:ring-primary"
              />
